  ...
  return (
    <AppLayout>
      <Container>
        ...
        <p>Soy una persona muy curiosa y <strong>me apasiona aprender</strong>. Siempre intento seguir formándome y actualizándome, por ejemplo ahora en Next.js, Socket.io o Three.js. He sido siempre autodidacta y lo sigo siendo desde que empecé a estudiar desarrollo web.</p>
        ...
        <p>Soy un gran aficionado al <strong>modelismo</strong>. Me encanta trastear con pinturas, pinceles, aerógrafos, esculpir y crear maquetas y dioramas. Desde hace tiempo me ha llamado la atención el mundo del <strong>diseño 3D</strong> y estoy aprendiendo a hacerlo con mi tableta gráfica.</p>
